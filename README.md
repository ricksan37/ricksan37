...
I'm Riccardo — Ricky for short — about a year and a half into turning myself from a salesperson into a data person.
...
`dbt` · `BigQuery` · `Snowflake` · `Salesforce` · `Fivetran` · `n8n` · `Tableau` · `SQL` · `Python`
